...
const pimoroni::IPAddress DNS_CLOUDFLARE(1, 1, 1, 1);
const pimoroni::IPAddress DNS_GOOGLE(8, 8, 8, 8);

using namespace pimoroni;

Pico2Wireless wireless;
uint8_t r, g, b;
...
int main() {
  ...
  if(!wifi_connect(NETWORK, PASSWORD, DNS_GOOGLE)) {
    return 0;
  }
